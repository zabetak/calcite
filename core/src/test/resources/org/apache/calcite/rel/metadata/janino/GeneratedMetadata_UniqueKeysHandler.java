...
public final class GeneratedMetadata_UniqueKeysHandler
  ...
  private final Object methodKey0 =
      new org.apache.calcite.rel.metadata.janino.DescriptiveCacheKey("Set Handler.getUniqueKeys(RelNode, RelMetadataQuery, Config)");
  ...
  public java.util.Set getUniqueKeys(
      ...
      org.apache.calcite.rel.metadata.BuiltInMetadata$UniqueKeys$Config a2) {
  ...
  private java.util.Set getUniqueKeys_(
    ...
    if (r instanceof org.apache.calcite.rel.core.Aggregate) {
      ...
      return provider0.getUniqueKeys((org.apache.calcite.rel.RelNode) r, mq, a2);
            ...
            throw new java.lang.IllegalArgumentException("No handler for method [public abstract java.util.Set org.apache.calcite.rel.metadata.BuiltInMetadata$UniqueKeys$Handler.getUniqueKeys(org.apache.calcite.rel.RelNode,org.apache.calcite.rel.metadata.RelMetadataQuery,org.apache.calcite.rel.metadata.BuiltInMetadata$UniqueKeys$Config)] applied to argument of type [" + r.getClass() + "]; we recommend you create a catch-all (RelNode) handler");
    }
  }
